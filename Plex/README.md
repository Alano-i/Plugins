...
- 如果想收到服务器有更新时带图片的通知，将本项目 `pic` 文件夹下 update_bg.gif（不要改后缀，保持gif，你也可以传你自己喜欢的图） 需要传到企业微信素材库从而获取 `thumb_media_id` 填入config中，[thumb_media_id获取方法](https://reurl.cc/RXGq86)
